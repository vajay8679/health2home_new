...
class VendorWithdrawalController extends AdminController
{
     ...
     * @var string
     */
    protected $title = 'Vendor Withdrawal';
    ...
    protected function form()
    {
        ...
        $form->image('reference_proof', __('Reference proof'))->uniqueName()->move('vendor_withdrawals');
        ...
        $form->saved(function (Form $form) {
            if($form->model()->status == 8){
                DB::table('vendors')->where('id',$form->vendor_id)->update([ 'wallet' => $form->existing_wallet ]);
            }
        });
