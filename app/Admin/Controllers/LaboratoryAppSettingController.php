...
class LaboratoryAppSettingController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Laboratory App Setting';
    ...
    {
        $grid = new Grid(new LaboratoryAppSetting());
        ...
        $grid->column('lab_radius', __('Lab Radius'));
    ...
    {
        $show = new Show(LaboratoryAppSetting::findOrFail($id));
    ...
    protected function form()
    {
        ...
        $form = new Form(new LaboratoryAppSetting());
        ...
        $form->text('lab_radius', __('Lab Radius'))->rules('required');
